...
class Day20Test extends AnyFunSuite {
  test("WrapAround") {
    assert(Day20Helper.wrapAround(0, 4) == 0)
    assert(Day20Helper.wrapAround(1, 4) == 1)
    assert(Day20Helper.wrapAround(2, 4) == 2)
    assert(Day20Helper.wrapAround(3, 4) == 3)
    assert(Day20Helper.wrapAround(4, 4) == 0)
    assert(Day20Helper.wrapAround(5, 4) == 1)
    assert(Day20Helper.wrapAround(6, 4) == 2)
    assert(Day20Helper.wrapAround(7, 4) == 3)
    assert(Day20Helper.wrapAround(8, 4) == 0)
    assert(Day20Helper.wrapAround(9, 4) == 1)
    assert(Day20Helper.wrapAround(10, 4) == 2)
    assert(Day20Helper.wrapAround(11, 4) == 3)
    assert(Day20Helper.wrapAround(3246356612L, 4) == 0)
    assert(Day20Helper.wrapAround(3246356613L, 4) == 1)
    assert(Day20Helper.wrapAround(3246356614L, 4) == 2)
    assert(Day20Helper.wrapAround(3246356615L, 4) == 3)
    assert(Day20Helper.wrapAround(3246356616L, 4) == 0)
    assert(Day20Helper.wrapAround(-1L, 4) == 3)
    assert(Day20Helper.wrapAround(-2L, 4) == 2)
    assert(Day20Helper.wrapAround(-3L, 4) == 1)
    assert(Day20Helper.wrapAround(-4L, 4) == 0)
    assert(Day20Helper.wrapAround(-5L, 4) == 3)
    assert(Day20Helper.wrapAround(-6L, 4) == 2)
    assert(Day20Helper.wrapAround(-7L, 4) == 1)
    assert(Day20Helper.wrapAround(-8L, 4) == 0)
  }
